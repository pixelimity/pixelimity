...
?>
      <form class="form-edit lists portfolio-tag-lists clearfix" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
        <header id="page-header" class="clearfix">
          <h1><?php echo $title; ?></h1>
          <div class="actions">
            <a class="btn btn-blue" href="<?php admin_url(); ?>/portfolio.php?action=add_new">Add New Portfolio</a>
          </div>
        </header>
        <!-- .page-header -->
        <div id="content">
