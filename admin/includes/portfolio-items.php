...
<form class="form-edit lists portfolio-lists clearfix" method="post" action="">
	...
	<header id="page-header" class="clearfix">
		...
		<div class="actions">
			<a class="btn btn-blue" href="<?php admin_url(); ?>/portfolio.php?action=add_new" target="_blank">Add New</a>
		</div>
