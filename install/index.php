				...
				<div id="content">
					...
					<div class="message clearfix">
						<?php if (isset($message)) : ?>
							<div class="msg msg-form msg-error"><?php echo $message; ?></div>
						<?php elseif (isset($_GET['installed']) && $_GET['installed'] == 'true') : ?>
							<div class="msg msg-form">Pixelimity was successfully installed. You can <a href="<?php echo URL; ?>/admin/login.php">login now</a> to access your admin.</div>
						<?php endif; ?>
					</div>
